...
public class User {
    ...
    public User(String classname,String url,String username,String password) {
        DB=new DatabaseConnection(classname,url,username,password);
    }
    ...
    public int updateProfile(String username,String password){
        try
        {
          return DB.excuteUpdate("update employees set username='"+username+"',password='"+password+"' where id = '"+getId()+"'");
