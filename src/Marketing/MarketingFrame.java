...
public class MarketingFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setText("  Hyper Market Management System");

        jLabel18.setFont(new java.awt.Font("Copperplate Gothic Light", 0, 20)); // NOI18N
        jLabel18.setText("      X");
...
int r=JOptionPane.showConfirmDialog(null, "Are you sure you want to sign out?", "Sign out",JOptionPane.YES_NO_OPTION);
    ...
    public void makeOffer()
    {
        ...
        String ldate=year_combo.getSelectedItem()+"-"+month_combo.getSelectedItem()+"-"+day_combo.getSelectedItem();
        ...
        if(r==1)
        {
            ...
            JOptionPane.showMessageDialog(null, "Offer Was Made Successfully", "Successfull",JOptionPane.OK_OPTION);
        }
        else
